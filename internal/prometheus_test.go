...
func TestNormalize(t *testing.T) {
	s := "1234567890)=azertyuiop^$qsdfghjklm*	<wxcvbn,;:!ABCDEFGHIJKLMNOPQRSTUVWXYZ./-"
	r := Prometheus{}.normalize(s)
	assert.Equal(t, "1234567890__azertyuiop__qsdfghjklm___wxcvbn____ABCDEFGHIJKLMNOPQRSTUVWXYZ./-", r)
}
